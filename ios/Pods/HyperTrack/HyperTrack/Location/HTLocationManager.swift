...
class LocationManager: NSObject, LocationManagerProtocol  {
    ...
    func getLastKnownHyperTrackLocation() -> HyperTrackLocation?{
        if let location = self.locationManager.location{
            let htLocation = HyperTrackLocation.init(clLocation: location, locationType: "point")
   ...
   func setupHeartbeatMonitoring() {
    ...
    public func getLocationFromLookUpId(lookUpId: String) -> HyperTrackLocation?{
...
extension LocationManager: CLLocationManagerDelegate {
    ...
    func locationManager(_ manager: CLLocationManager,
        ...
        var htLocations = [HyperTrackLocation]()
