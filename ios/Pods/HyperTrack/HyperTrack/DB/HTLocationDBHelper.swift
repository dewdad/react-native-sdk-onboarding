...
class HTLocationDBHelper: HTBaseDBHelper {
    ...
    func insert(htLocation: HyperTrackLocation){
        do {
    ...
    func getLocationFromLookUpId(lookUpId: String) -> HyperTrackLocation?{
        ...
        var location: HyperTrackLocation?
        do {
            ...
            if let result = queryResult {
                for locationResult in result {
                    ...
                    location = HyperTrackLocation.init(clLocation: clLocation, locationType: "point", activityLookUpId: activityLookUpId, provider: "gps")
