...
typealias HTActionResultHandler = (_ action: HyperTrackAction?, _ error: HyperTrackError?) -> Void
...
class HTActionService: NSObject {
    ...
    func getAction(_ actionId: String, _ completionHandler: @escaping HTActionResultHandler) {
    ...
    func createAndAssignAction(_ actionParams: HyperTrackActionParams, _ completionHandler: @escaping HTActionResultHandler) {

        var action = [
            "user_id": HTUserService.sharedInstance.userId as Any,
    ...
    func completeActionInSynch(actionId: String, completionHandler: @escaping HTActionResultHandler) {
        let params = [String: Any]()
        self.requestManager.completeActionInSynch(actionId, params, completionHandler: completionHandler)
    }

    func completeActionWithLookupId(lookupId: String) {
        HTSDKDataManager.sharedInstance.saveActionCompletedEvent(lookUpId: lookupId)
    }

    func patchExpectedPlaceInAction(actionId: String, newExpectedPlaces: HyperTrackPlace, _ completionHandler: @escaping HTActionResultHandler) {
     ...
     */
    func trackActionFor(actionID: String, completionHandler: HTActionResultHandler?) {
     ...
     */
    func trackActionFor(shortCode: String, completionHandler: HTActionResultHandler?) {
