...
/**
 Instance of HyperTrackAction represent the action API entity. An Action is a pickup, delivery,
 visit or any other transaction event being performed by the User.
 For more information, visit https://docs.hypertrack.com/api/entities/action.html
 */
@objc public class HyperTrackAction: NSObject {
    ...
    /**
     Action collection id can be an internal identifier used to access this action object
     */
    ...
    public static func fromJson(data: Data?) -> HyperTrackAction? {
        do {
            ...
            DDLogError("Error in getting action from json: " + error.localizedDescription)
            return nil
        }
    }
