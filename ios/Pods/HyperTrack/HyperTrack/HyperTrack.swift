...
@objc public class HyperTrack: NSObject {
    ...
    @objc public class func startTracking() {
        HypertrackService.sharedInstance.startTracking(completionHandler: nil)
    }
    ...
    @objc public class func startMockTracking() {
        HypertrackService.sharedInstance.startMockTracking(completionHandler: nil)
    }
    ...
    @objc public class func startTracking(completionHandler: @escaping (_ error: HyperTrackError?) -> Void) {
        HypertrackService.sharedInstance.startTracking(completionHandler: completionHandler)
    }
    /**
    ...
    @objc public class func setUserId(_ userId: String) {
        HTUserService.sharedInstance.userId = userId
    }
    ...
    @objc public class func stopTracking() {
        HypertrackService.sharedInstance.stopTracking(completionHandler: nil)
    }
    ...
    @objc public class func stopTracking(completionHandler: @escaping (_ error: HyperTrackError?) -> Void) {
        HypertrackService.sharedInstance.stopTracking(completionHandler: completionHandler)
    }
    ...
    @objc public class func stopMockTracking() {
        HypertrackService.sharedInstance.stopMockTracking()
    }
    ...
    @objc public class func requestWhenInUseAuthorization() {
        HTSDKDataManager.sharedInstance.locationManager.requestWhenInUseAuthorization()
    }
    ...
    @objc public class func requestAlwaysAuthorization() {
        HTSDKDataManager.sharedInstance.locationManager.requestAlwaysAuthorization()
    }
    ...
    @objc public class func startMockTracking(params: HTMockLocationParams) {
        HypertrackService.sharedInstance.startMockTracking(origin: params.origin, destination: params.destination, completionHandler: nil)
    }
    
    @objc public class func getCurrentActivity() -> HyperTrackActivity? {
      return HTSDKDataManager.sharedInstance.activityManager.getCurrentActivity()?.toHyperTrackActivity()
    }
