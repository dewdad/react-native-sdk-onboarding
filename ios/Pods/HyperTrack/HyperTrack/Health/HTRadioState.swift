...
class HTRadioState: HTHealthDataProtocol {
    ...
    var networkConnectedAt: Date? {
        get {
            return HypertrackUserDefaults.standard.object(forKey: networkConnectedKey) as? Date
        }
        
        set {
            HypertrackUserDefaults.standard.set(newValue, forKey: networkConnectedKey)
    ...
    var networkDisconnectedAt: Date? {
        get {
            return HypertrackUserDefaults.standard.object(forKey: networkDisconnectedKey) as? Date
        }
        
        set {
            HypertrackUserDefaults.standard.set(newValue, forKey: networkDisconnectedKey)
            HypertrackUserDefaults.standard.synchronize()
        }
    }
