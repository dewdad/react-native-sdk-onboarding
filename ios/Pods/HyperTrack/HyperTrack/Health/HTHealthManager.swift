...
class HTHealthManager: NSObject {
    ...
    func checkDeviceInfoData(){
        ...
        if let previousData = HypertrackUserDefaults.standard.data(forKey: HTSDKHealthType.deviceInfoChanged.rawValue) {
    ...
    func saveDeviceInfoChangeSegment(data: HTDeviceInfo) {
        ...
        HypertrackUserDefaults.standard.set(data.getJsonData(), forKey: HTSDKHealthType.deviceInfoChanged.rawValue)
   ...
   func currentBatteryLevel() -> Double{
    ...
    func getLastKnownInfo(infoType: HTSDKHealthType) -> HTHealthDataProtocol? {
        if let data = HypertrackUserDefaults.standard.data(forKey: infoType.rawValue){
    ...
    func saveLastKnownInfo(infoType: HTSDKHealthType, model: HTHealthDataProtocol ) {
        HypertrackUserDefaults.standard.set(model.getJsonData(), forKey: infoType.rawValue)
        HypertrackUserDefaults.standard.synchronize()
    }
    ...
    func saveUpTime(upTime: TimeInterval){
        HypertrackUserDefaults.standard.set(upTime, forKey: lastUpTimeKey)
    }
 
    func getLastSavedSystemUpTime() -> TimeInterval? {
       return HypertrackUserDefaults.standard.double(forKey:lastUpTimeKey)
    }
